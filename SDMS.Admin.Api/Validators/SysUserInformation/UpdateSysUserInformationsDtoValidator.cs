...
{
    public class UpdateSysUserInformationDtoValidator : BaseValidator<UpdateSysUserInformationDto>
    {
        private readonly IStringLocalizer<SharedResource> _localizer;
        public UpdateSysUserInformationDtoValidator(IStringLocalizer<SharedResource> localizer)
        {
